#https://github.com/Aniell4/MassDN-source/blob/main/scrape.py
                ...
                for elem, index in enumerate(parsed["types"]):
                    if index == "SYNC":
                        ...
                        for item in parsed["updates"][elem]:
                            if "member" in item:
                                mem = item["member"]
                                obj = {"tag": mem["user"]["username"], "avatar": mem["user"]["avatar"]}
                        ...
                        for item in parsed["updates"][elem]:
                            if "member" in item:
                                mem = item["member"]
                                obj = {"tag": mem["user"]["username"], "id": mem["user"]["id"], "avatar": mem["user"]["avatar"]}
